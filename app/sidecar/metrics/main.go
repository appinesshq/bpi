...
import (
	...
	"github.com/appinesshq/bpi/app/sidecar/metrics/collector"
	"github.com/appinesshq/bpi/app/sidecar/metrics/publisher"
	"github.com/appinesshq/bpi/app/sidecar/metrics/publisher/expvar"
...
func run(log *log.Logger) error {
	...
	var cfg struct {
		...
		Collect struct {
			From string `conf:"default:http://bpi-api:4000/debug/vars"`
		}
		Publish struct {
